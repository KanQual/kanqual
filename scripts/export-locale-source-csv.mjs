...
function mapKeyToHierarchy(key) {
  const rules = [
    ...
    { prefix: "projectCases.help.", screenId: "top-level-screens.project-cases.help-modal", confidence: "exact" },
    { prefix: "projectCases.deleteModal.", screenId: "top-level-screens.project-cases.delete-case-confirmation-modal", confidence: "exact" },
    { prefix: "projectCases.attribute", screenId: "top-level-screens.project-cases.case-attribute-modal", confidence: "best-effort" },
    { prefix: "projectCases.", screenId: "top-level-screens.project-cases", confidence: "best-effort" },
    ...
    { prefix: "projectSettings.shell.", screenId: "top-level-screens.project-settings.overview-workspace", confidence: "best-effort" },
    { prefix: "projectSettings.overview.", screenId: "top-level-screens.project-settings.overview-workspace", confidence: "exact" },
    { prefix: "projectSettings.modal.currentDetails", screenId: "top-level-screens.project-settings.setup-section.project-details-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.noProjectDescription", screenId: "top-level-screens.project-settings.setup-section.project-details-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.details", screenId: "top-level-screens.project-settings.setup-section.project-details-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.sharedImportDefaults", screenId: "top-level-screens.project-settings.setup-section.document-import-defaults-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.retainedSourceFiles", screenId: "top-level-screens.project-settings.project-data-section.retained-uploaded-files-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.unnamedUpload", screenId: "top-level-screens.project-settings.project-data-section.retained-uploaded-files-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.orphanedBadge", screenId: "top-level-screens.project-settings.project-data-section.retained-uploaded-files-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.linkedBadge", screenId: "top-level-screens.project-settings.project-data-section.retained-uploaded-files-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.unknownFileType", screenId: "top-level-screens.project-settings.project-data-section.retained-uploaded-files-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.linkedDocument", screenId: "top-level-screens.project-settings.project-data-section.retained-uploaded-files-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.deletedDocument", screenId: "top-level-screens.project-settings.project-data-section.retained-uploaded-files-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.linkedCase", screenId: "top-level-screens.project-settings.project-data-section.retained-uploaded-files-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.deletedCase", screenId: "top-level-screens.project-settings.project-data-section.retained-uploaded-files-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.uploadedAt", screenId: "top-level-screens.project-settings.project-data-section.retained-uploaded-files-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.projectActivity", screenId: "top-level-screens.project-settings.project-data-section.project-log-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.exportLog", screenId: "top-level-screens.project-settings.project-data-section.project-log-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.backup", screenId: "top-level-screens.project-settings.project-data-section.backups-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.hourlyWindow", screenId: "top-level-screens.project-settings.project-data-section.backups-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.dailyWindow", screenId: "top-level-screens.project-settings.project-data-section.backups-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.weeklyWindow", screenId: "top-level-screens.project-settings.project-data-section.backups-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.minimumAutomaticBackupInterval", screenId: "top-level-screens.project-settings.project-data-section.backups-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.encryptedBackup", screenId: "top-level-screens.project-settings.exchange-section.export-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.wholeProjectExports", screenId: "top-level-screens.project-settings.exchange-section.export-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.reviewExport", screenId: "top-level-screens.project-settings.exchange-section.export-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.codebook", screenId: "top-level-screens.project-settings.exchange-section.codebook-exchange-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.importRefiQdaCodebook", screenId: "top-level-screens.project-settings.exchange-section.codebook-exchange-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.exportRefiQdaCodebook", screenId: "top-level-screens.project-settings.exchange-section.codebook-exchange-modal", confidence: "best-effort" },
    { prefix: "projectSettings.modal.", screenId: "top-level-screens.project-settings", confidence: "best-effort" },
