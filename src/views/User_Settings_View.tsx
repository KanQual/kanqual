...
import { EyeIcon, EyeOffIcon, SettingsAppearanceIcon, SettingsProfileIcon } from "../components/AppIcons";
...
export function UserSettingsView({
  ...
  return (
    <div className={embedded ? "user-settings-view user-settings-view--embedded" : "view user-settings-view"}>
      {!embedded ? (
        <ViewHeader
          title={t("userSettings.sections.pageTitle")}
          titleClassName="view-title-with-help"
          help={{ label: "Open user settings help", onClick: () => setHelpOpen(true) }}
        />
      ) : null}

      {!embedded && helpOpen ? (
        <HelpModal
          title={t("userSettings.help.title")}
      ...
      <div className="app-settings-overview-shell user-settings-overview-shell">
        <div className={embedded ? "app-settings-overview-stack app-settings-overview-stack--compact" : "app-settings-overview-stack"}>
          <div className="app-settings-overview-sections">
            <SettingsOverviewSection heading={embedded ? undefined : t("userSettings.sections.accountEyebrow")} compact={embedded}>
              <SettingsOverviewCard
                compact={embedded}
                icon={<SettingsProfileIcon />}
                title={t("userSettings.cards.profileTitle")}
                description={t("userSettings.cards.profileOverviewDescription")}
                onActivate={() => setActiveModal("profile")}
              />
            </SettingsOverviewSection>
            {includeAppearance ? (
              <SettingsOverviewSection heading={embedded ? undefined : t("userSettings.sections.preferencesEyebrow")} compact={embedded}>
                <SettingsOverviewCard
                  compact={embedded}
                  icon={<SettingsAppearanceIcon />}
                  title={t("userSettings.cards.appearanceTitle")}
                  description={t("userSettings.cards.appearanceOverviewDescription")}
                  onActivate={() => setActiveModal("appearance")}
                />
              </SettingsOverviewSection>
            ) : null}
          </div>
      ...
      {activeModal === "profile" ? (
        <SettingsModal title={t("userSettings.cards.profileTitle")} onClose={() => setActiveModal(null)}>
                ...
                <section className="app-settings-modal-section">
                  <div className="app-settings-modal-section-body">
                    <div className="form">
                      ...
                      >
                        {t("userSettings.modal.changePasswordSentenceCase")}
                      </button>
                    </div>
                  </div>
                </section>
      ...
      {activeModal === "password" ? (
        <SettingsModal title={t("userSettings.modal.passwordTitle")} onClose={() => {
              ...
              <div className="app-settings-modal-sections">
                <section className="app-settings-modal-section">
                  <div className="app-settings-modal-section-body">
                      ...
                      <label className="form-label" style={{ marginTop: 8 }}>{t("userSettings.modal.currentPassword")}
                        <div className="password-input-wrap">
                          ...
                          <button
                            ...
                            aria-label={currentPasswordVisible ? t("common.hidePassword") : t("common.showPassword")}
                      ...
                      <label className="form-label">{t("userSettings.modal.newPassword")}
                        <div className="password-input-wrap">
                          <input
                            className="form-input password-input-field"
                        ...
                        <p className="password-requirement-note">{t("userSettings.modal.minimumEightCharacters")}</p>
                      </label>
                      <label className="form-label">{t("userSettings.modal.confirmNewPassword")}
                        <div className="password-input-wrap">
                          <input
                            className="form-input password-input-field"
                      ...
                      {confirmPassword && newPassword !== confirmPassword ? (
                        <p className="settings-warning settings-warning--danger" style={{ margin: 0 }}>
                          {t("userSettings.modal.passwordEntriesDoNotMatch")}
                        </p>
                      ) : null}
                  </div>
                </section>
      ...
      {activeModal === "appearance" ? (
        <SettingsModal title={t("userSettings.cards.appearanceTitle")} onClose={() => setActiveModal(null)}>
            <div className="app-settings-modal-body">
              <div className="app-settings-modal-sections">
                <section className="app-settings-modal-section">
                  <div className="app-settings-modal-section-header app-settings-modal-section-header--default"><h3>{t("userSettings.modal.interfaceTitle")}</h3></div>
                  <div className="app-settings-modal-section-body">
                    ...
                    <div className="settings-row">
                      <div className="settings-row-info">
                        ...
                        <div className="settings-row-desc">{t("userSettings.modal.interfaceDensityOverviewDescription")}</div>
                      </div>
                    ...
                    <div className="settings-row">
                      <div className="settings-row-info">
                        ...
                        <div className="settings-row-desc">{t("userSettings.modal.textSizeOverviewDescription")}</div>
                      </div>
                      <div className="segmented-control">
                    ...
                    <div className="settings-row">
                      <div className="settings-row-info">
                        <div className="settings-row-label">{t("userSettings.modal.sourceAndCodingText")}</div>
                        <div className="settings-row-desc">{t("userSettings.modal.sourceAndCodingTextDescription")}</div>
                      </div>
                      <TextSizeControls
                    ...
                    <div className="settings-row">
                      <div className="settings-row-info">
                        <div className="settings-row-label">{t("userSettings.modal.language")}</div>
                        <div className="settings-row-desc">{t("userSettings.modal.languageDescription")}</div>
                      </div>
