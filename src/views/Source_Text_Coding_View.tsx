...
import { ZoomIcon } from "../components/AppIcons";
...
export function SourceTextCodingView({
  row,
  codes,
  annotations,
  codeOptions,
  ...
  return (
    <div className="view doc-detail-view">
      <ViewHeader
        ...
        help={{ label: t("sourceCoding.text.openHelp"), onClick: () => setHelpOpen(true) }}
      />
      ...
      <div className="workbench-layout coding-workspace-layout" style={{ minHeight: 0 }}>
        ...
        <div className="workbench-main">
          <div className={`workspace-panel workspace-panel--grow${gettingStartedAssignCodeActive && !pendingSelection ? " getting-started-spotlight-target workspace-panel--getting-started" : ""}`}>
      ...
      {helpOpen ? (
        <HelpModal
          ...
          lines={[t("sourceCoding.text.helpLine1"), t("sourceCoding.text.helpLine2")]}
        />
      ) : null}
