...
import { DeleteIcon, PlusIcon, ProcessTranscriptIcon } from "../components/AppIcons";
...
export function AIAssistProcessSourcesView({
  projectId,
  ...
  if (reviewWorkspaceOpen) {
    return (
      <div className="view ai-process-doc-view ai-process-doc-view--reviewing">
        ...
        <ViewHeader
          title={t("aiAssist.processSources.reviewTitle")}
          help={{ label: t("aiAssist.processSources.openHelp"), onClick: () => setHelpOpen(true) }}
          actions={<div className="view-header-actions">
            <button
              type="button"
                ...
                {!selectedReviewRecord ? (
                  ...
                  <>
                    ...
                    {selectedReviewRecord.processingStatus === "partial" ? (
                      <div className="permission-note" style={{ marginBottom: 12 }}>
        ...
        {helpOpen ? (
          <HelpModal
            title={t("aiAssist.processSources.help.reviewTitle")}
            onClose={() => setHelpOpen(false)}
            lines={[t("aiAssist.processSources.help.reviewLine1")]}
  ...
  return (
    <div className="view view-shell ai-process-doc-view">
      <ViewHeader
        title={t("aiAssist.processSources.title")}
        help={{ label: t("aiAssist.processSources.openHelp"), onClick: () => setHelpOpen(true) }}
        actions={<div className="view-header-actions">
      ...
      >
          ...
          <section className="content-card" style={{ padding: 0, overflow: "hidden" }}>
            ...
            <div>
              <table className="data-table" style={{ tableLayout: "fixed" }}>
                <thead>
                  <tr>
                    <th className="data-table-header" style={{ width: "62%" }}>{t("aiAssist.processSources.group")}</th>
                    <th className="data-table-header" style={{ width: "38%" }}>{t("aiAssist.processSources.count")}</th>
                  </tr>
                </thead>
                <tbody>
                  {processGroupRows.map((group) => (
                    ...
                    >
                      ...
                      <td className="data-table-cell data-table-cell--muted">{group.count}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        >
          <div className="content-card ai-process-doc-source-card">
            ...
            <table className="data-table">
              <thead>
                {selectedProcessGroup === "raw" ? (
                  <tr>
                    <th className="data-table-header" style={{ width: "8%" }} />
                    <th className="data-table-header" style={{ width: "44%" }}>{t("aiAssist.processSources.source")}</th>
                    <th className="data-table-header" style={{ width: "18%" }}>{t("aiAssist.processSources.type")}</th>
                    <th className="data-table-header" style={{ width: "14%" }}>{t("aiAssist.processSources.status")}</th>
                    <th className="data-table-header" style={{ width: "16%" }}>{t("aiAssist.processSources.updated")}</th>
                  </tr>
                ) : (
                  <tr>
                    <th className="data-table-header" style={{ width: "42%" }}>{t("aiAssist.processSources.source")}</th>
                    <th className="data-table-header" style={{ width: "18%" }}>{t("aiAssist.processSources.status")}</th>
                    <th className="data-table-header" style={{ width: "16%" }}>{t("aiAssist.processSources.chunks")}</th>
                    <th className="data-table-header" style={{ width: "24%" }}>{t("aiAssist.processSources.processed")}</th>
                  </tr>
                )}
              </thead>
              <tbody>
                {loading ? (
                  <tr>
                    <td colSpan={selectedProcessGroup === "raw" ? 5 : 4} className="data-table-message">{t("aiAssist.processSources.loadingSources")}</td>
                  </tr>
                ) : selectedProcessGroup === "raw" ? (
                  processableSources.length === 0 ? (
                    <tr>
                      <td colSpan={5} className="data-table-message">{t("aiAssist.processSources.noRawTextSources")}</td>
                    </tr>
                  ) : (
                    processableSources.map((source) => {
                      ...
                      return (
                        <tr
                          key={source.id}
                          className={`data-table-row case-list-row${checked ? " assoc-doc-row--selected" : ""}`}
                        ...
                        >
                          ...
                          <td className="data-table-cell data-table-cell--name">{source.title || t("aiAssist.processSources.untitledSource")}</td>
                          <td className="data-table-cell data-table-cell--muted">{source.sourceKind || t("aiAssist.processSources.text")}</td>
                          <td className="data-table-cell data-table-cell--muted">{status}</td>
                          <td className="data-table-cell data-table-cell--muted">{formatProcessedReviewDate(source.updatedAt)}</td>
                        </tr>
                      );
                    })
                  )
                  ...
                  <tr>
                    <td colSpan={4} className="data-table-message">{t("aiAssist.processSources.noProcessedSources")}</td>
                  </tr>
                ) : (
                  reviewRecords.map((record) => (
                    <tr
                      key={record.id}
                      className={`data-table-row case-list-row${selectedReviewRecord?.id === record.id ? " assoc-doc-row--selected" : ""}`}
                      onClick={() => {
                      ...
                      style={{ cursor: "pointer" }}
                    >
                      <td className="data-table-cell data-table-cell--name">{record.sourceTitle || t("aiAssist.processSources.untitledSource")}</td>
                      ...
                      <td className="data-table-cell data-table-cell--muted">{record.processedChunkCount}/{record.chunkCount}</td>
                      <td className="data-table-cell data-table-cell--muted">{formatProcessedReviewDate(record.updatedAt)}</td>
                    </tr>
                  ))
                )}
              </tbody>
      ...
      {helpOpen ? (
        <HelpModal
          title={t("aiAssist.processSources.help.title")}
          onClose={() => setHelpOpen(false)}
          lines={[t("aiAssist.processSources.help.line1")]}
          modalClassName="modal--wide"
          showCloseAction={false}
        />
      ) : null}
