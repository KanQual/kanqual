...
function ProjectHomeCanvasSizeSection({
  ...
  const { t } = useI18n();
  return (
    <section className="content-card project-home-selector-card project-home-size-section">
      <div
        className="workspace-panel-header project-home-selector-card-header"
        role="button"
        tabIndex={0}
      ...
      {!collapsed ? (
        <div className="data-table-wrap project-home-selector-table-wrap">
          <table className="data-table project-home-selector-table project-home-size-table">
            <thead>
              <tr>
                <th className="data-table-header" style={{ width: "52%" }}>{t("common.name")}</th>
                <th className="data-table-header" style={{ width: "16%" }}>{t("projectCore.entities.count")}</th>
                <th className="data-table-header" style={{ width: "32%" }}>{t("projectCore.entities.size")}</th>
              </tr>
            </thead>
            <tbody>
              {rows.length === 0 ? (
                <tr>
                  <td className="data-table-message" colSpan={3}>{emptyText}</td>
                </tr>
              ) : rows.map((row) => (
...
export function ProjectHomeGraphView({
  createControlRef,
  filterControlRef,
  sizeControlRef,
  createMenuOpen,
  ...
  return (
    <div className="home-dashboard project-home-dashboard">
                    ...
                    {sizeMenuOpen ? (
                      <div className="project-home-size-menu">
                        ...
                        {sizeGroupCount === 0 ? (
                          ...
                          <div className="home-primary-column project-home-primary-column project-home-selector-column project-home-selector-column--drawer project-home-size-section-column">
