...
export type AIAssistHomeViewProps = {
...
export function AIAssistHomeView({
  project,
  authSession,
  canManageProject,
  canManageEmbeddings,
}: AIAssistHomeViewProps) {
  const { t } = useI18n();
  ...
  return (
    <div className="view home-view ai-assist-home-view">
      <ViewHeader
        ...
        help={{ label: t("aiAssist.home.openHelp"), onClick: () => setHelpOpen(true) }}
      />

      {helpOpen ? (
        <HelpModal
          title={t("aiAssist.home.help.title")}
          onClose={() => setHelpOpen(false)}
          lines={[t("aiAssist.home.help.line1"), t("aiAssist.home.help.line2")]}
        />
      ) : null}
      ...
      <div className="ai-assist-home-layout">
        <div className="ai-assist-home-info-column">
          <section className="content-card ai-assist-home-card ai-assist-home-status-card">
            <div className="content-card-header">
          ...
          <div className="ai-assist-home-tabbar">
            ...
            <section className="ai-assist-home-action-group">
              ...
              <div className="ai-assist-home-card-row">
                <section
                  className="content-card ai-assist-home-card ai-assist-home-card--balanced ai-assist-compact-setup-card ai-assist-embeddings-card"
                ...
                >
                  ...
                  {!hasEmbeddingModel ? <div className="permission-note ai-assist-home-disabled-note">{t("aiAssist.home.messages.downloadModelFirst")}</div> : null}
                  {!isLocalWorkspace ? <div className="permission-note">{t("aiAssist.home.messages.remoteEmbeddingBuildsOnHost")}</div> : null}
                  {isLocalWorkspace && !canManageEmbeddings ? <div className="permission-note">{t("aiAssist.home.messages.onlyEmbeddingManagersCanManage")}</div> : null}
              ...
              <div className="ai-assist-home-card-row">
              <section className="content-card ai-assist-home-card ai-assist-llm-connection-card" style={{ gridColumn: "1 / -1" }}>
                <div className="content-card-header">
                  <div>
