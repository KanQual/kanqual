...
import { SourceCodebookCard } from "./Source_Coding_Shared";
...
export function AIAssistAnalyzeView({
  projectId,
  ...
  return (
    <div className="view workbench-view ai-assisted-coding-view">
      <div className="ai-assist-analyze-header">
        <div className="view-title-row">
          <h1>{t("aiAssist.analyze.title")}</h1>
          <button type="button" className="view-header-help-button" onClick={() => setHelpOpen(true)} title={t("aiAssist.analyze.openHelp")} aria-label={t("aiAssist.analyze.openHelp")}>
      ...
      {loading ? <p className="supporting-copy">{t("aiAssist.analyze.loading")}</p> : null}
      ...
      <div className="workbench-layout ai-assisted-coding-layout ai-assisted-coding-analyze-layout">
        <div className="workbench-sidebar">
          ...
          <div className="workspace-panel" style={{ marginTop: 16 }}>
            <div className="workspace-panel-header">
              <span className="workspace-panel-title">{t("aiAssist.analyze.savedAnalyses")}</span>
              <button
                type="button"
        ...
        <div className="workbench-main">
          <div className="workspace-panel workspace-panel--grow ai-analyze-results-card">
            <div className="workspace-panel-header">
              <span className="workspace-panel-title">{t("aiAssist.analyze.analysis")}</span>
              {loadedAnalysis ? (
      ...
      {helpOpen ? (
        <HelpModal
          title={t("aiAssist.analyze.help.title")}
          onClose={() => setHelpOpen(false)}
          lines={[t("aiAssist.analyze.help.line1")]}
