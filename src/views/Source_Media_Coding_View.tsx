...
export function SourceMediaCodingView({
  row,
  codes,
  annotations,
  codeOptions,
  ...
  return (
    <div className="view doc-detail-view">
      <ViewHeader
        title={mediaKind === "audio" ? t("sourceCoding.media.codeAudio") : t("sourceCoding.media.codeVideo")}
        ...
        help={{ label: t("sourceCoding.media.openHelp", { kind: mediaKind }), onClick: () => setHelpOpen(true) }}
      />
              ...
              <div style={{ display: "grid", gap: 16, minHeight: 0 }}>
                ...
                <div className="media-player-console-frame">
                  ...
                  <div className="media-player-waveform-panel media-player-waveform-panel--audio">
                    ...
                    <div className="media-player-transport-waveform-row media-player-audio-waveform-row">
                      <div className="media-player-transport-waveform-square" aria-label={t("sourceCoding.media.audioTransportControls")}>
                        <button
                          type="button"
                      ...
                      <div className="media-player-transport-waveform-side-rect" aria-label={t("sourceCoding.media.audioSecondaryControls")}>
                        <div
                      ...
                      />
                      {!activeClipRange ? (
                        <div className="media-player-transport-waveform-actions media-player-audio-waveform-actions" aria-label={t("sourceCoding.media.audioClipActions")}>
                          <button
                            type="button"
                  ...
                  {activeClipRange ? (
                    <div className="media-player-transport-action-card" aria-label={t("sourceCoding.media.audioClipActions")}>
