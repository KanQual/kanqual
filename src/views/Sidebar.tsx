...
export type SidebarNetworkMode = "device" | "network" | "internet" | "unknown";
export type SidebarAiStatus = "ready" | "running" | "disabled" | "unavailable";
export type SidebarCollaborationStatus = "idle" | "active-solo" | "active-shared" | "disabled";
  ...
  return (
    <aside className={`sidebar${forceExpanded ? " sidebar--expanded" : ""}${guideSpotlightSidebar ? " getting-started-spotlight-target sidebar--getting-started" : ""}`}>
      <div className="sidebar-brand">
        <img src={sidebarLogo} alt={t("app.loadingCard.productNameSentenceCase")} className="brand-logo" />
        <div className="brand-collapsed-lockup" aria-hidden="true">
          <img src={sidebarMarkLogo} alt="" className="brand-collapsed-logo" />
          <span className="brand-collapsed-title">{t("app.loadingCard.productName")}</span>
        </div>
