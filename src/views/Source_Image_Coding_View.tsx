...
export function SourceImageCodingView({
  row,
  codes,
  annotations,
  codeOptions,
  ...
  onDeleteCode,
  onBack,
}: SourceCodingViewProps & { projectStoragePath: string }) {
  const { t } = useI18n();
  ...
  return (
    <div className="view doc-detail-view">
      <ViewHeader
        title={t("sourceCoding.image.title", { label: codingSourceLabel })}
        ...
        help={{ label: t("sourceCoding.image.openHelp", { name: codingSourceName }), onClick: () => setHelpOpen(true) }}
      />
      ...
      <div className="workbench-layout coding-workspace-layout" style={{ minHeight: 0 }}>
        ...
        <div className="workbench-main">
          <div className="workspace-panel workspace-panel--grow">
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  {isPdfSource && pdfPageCount > 0 ? (
                    <>
                      ...
                      <span className="supporting-copy" style={{ margin: 0, whiteSpace: "nowrap" }}>
            ...
            {imagePreviewLoading ? (
              <p className="supporting-copy" style={{ margin: 0 }}>{t("sourceCoding.image.loadingPreview")}</p>
            ) : imagePreviewError ? (
                        ...
                        return (
                          ...
                          >
                            <button
                              ...
                              type="button"
                              title={annotation.codeLabels.join(", ") || t("sourceCoding.image.annotationFallback")}
                              onClick={(event) => {
                                event.stopPropagation();
      ...
      {helpOpen ? (
        <HelpModal
          title={t("sourceCoding.image.helpTitle", { label: codingSourceLabel })}
          onClose={() => setHelpOpen(false)}
          lines={[t("sourceCoding.image.helpLine1"), t("sourceCoding.image.helpLine2")]}
        />
      ) : null}
