  ...
  return (
    <div className="view app-settings-view app-settings-view--admin">
      <ViewHeader
        ...
        titleClassName="admin-settings-title-row"
        help={{
          label: t("adminSettings.openHelp"),
      ...
      {helpOpen ? (
        <HelpModal
          title={t("adminSettings.helpTitle")}
          onClose={() => setHelpOpen(false)}
          lines={[t("adminSettings.helpLine1"), t("adminSettings.helpLine2")]}
        />
      ) : null}
        ...
        <div className="app-settings-overview-stack app-settings-overview-stack--admin">
          <div className="app-settings-overview-sections">
            {appSettingsSections.map((section) => (
              <SettingsOverviewSection key={section.id} heading={section.sectionHeading} compact>
                  {section.cards.map((card) => (
                    <SettingsOverviewCard
                      ...
                      ) && !gettingStartedState.completed && !gettingStartedState.dismissed ? "getting-started-spotlight-target" : undefined}
                      icon={card.icon}
                      title={card.title}
              ...
              {aiAssistAdminTab === "usage" ? (
                <div className="app-settings-modal-sections">
                  ...
                  {aiAssistPolicyMode === "project" ? (
                    <SettingsModalSection title={t("adminSettings.system.aiAssist.projects")}>
                      <div className="data-table-wrap data-table-wrap--elevated" style={{ maxHeight: 360 }}>
                        <table className="data-table" style={{ tableLayout: "auto", width: "100%" }}>
                          <thead>
                            <tr>
                              <th className="data-table-header">{t("adminSettings.system.aiAssist.project")}</th>
                              <th className="data-table-header" style={{ width: 220, whiteSpace: "nowrap" }}>{t("adminSettings.system.aiAssist.status")}</th>
                            </tr>
                          </thead>
                          <tbody>
                            {projects.length === 0 ? (
                              <tr>
                                <td className="data-table-cell data-table-cell--muted" colSpan={2}>{t("adminSettings.system.aiAssist.noProjectsYet")}</td>
                              </tr>
                            ) : projects.map((project) => {
                              const allowed = aiAssistAllowedForProject(project.id);
                              return (
                                <tr key={project.id} className="data-table-row">
                                  <td className="data-table-cell data-table-cell--name">{project.name}</td>
                                  <td className="data-table-cell" style={{ width: 220, whiteSpace: "nowrap" }}>
                  ...
                  <SettingsModalSection title={t("adminSettings.system.aiAssist.customModel")}>
                    ...
                    <div className="data-table-wrap" style={{ marginBottom: 12 }}>
                      <table className="data-table">
                        <thead>
                          <tr>
                            <th className="data-table-header">{t("adminSettings.system.aiAssist.model")}</th>
                            <th className="data-table-header">{t("adminSettings.system.aiAssist.source")}</th>
                            <th className="data-table-header">{t("adminSettings.system.aiAssist.added")}</th>
                            <th className="data-table-header">{t("adminSettings.system.aiAssist.size")}</th>
                            <th className="data-table-header">{t("adminSettings.system.aiAssist.action")}</th>
                          </tr>
                        </thead>
                        <tbody>
                          {activeCustomEmbeddingModel || partialCustomEmbeddingModel ? (
                            <tr>
                              <td className="data-table-cell">
                                ...
                                <div className="data-table-cell--muted">{(activeCustomEmbeddingModel ?? partialCustomEmbeddingModel)?.modelDir}</div>
                                {partialCustomEmbeddingModel ? (
                                  <div className="data-table-cell--muted">{t("adminSettings.system.aiAssist.partialDownload")}</div>
                                ) : null}
                              </td>
                              <td className="data-table-cell data-table-cell--muted" style={{ whiteSpace: "nowrap" }}>
                              ...
                              <td className="data-table-cell" style={{ whiteSpace: "nowrap" }}>
                            ...
                            <tr>
                              <td className="data-table-cell data-table-cell--muted" colSpan={5}>
                ...
                <div className="app-settings-modal-sections">
                  <SettingsModalSection title={t("adminSettings.system.aiAssist.localProviders")} className="app-settings-modal-section--compact-controls">
                    ...
                    <div className="data-table-wrap data-table-wrap--elevated" style={{ maxHeight: 260 }}>
                      <table className="data-table" style={{ tableLayout: "fixed", width: "100%" }}>
                        <thead>
                          <tr>
                            <th className="data-table-header" style={{ width: "28%" }}>{t("adminSettings.system.aiAssist.provider")}</th>
                            <th className="data-table-header" style={{ width: "34%" }}>{t("adminSettings.system.aiAssist.endpoint")}</th>
                            <th className="data-table-header" style={{ width: "22%" }}>{t("adminSettings.system.aiAssist.models")}</th>
                            <th className="data-table-header" style={{ width: 64, textAlign: "right" }}>{t("adminSettings.system.aiAssist.actions")}</th>
                          </tr>
                        </thead>
                        <tbody>
                          {!savedLocalLlmProvider || !aiAssistLlmSettings ? (
                            <tr>
                              <td className="data-table-cell data-table-cell--muted" colSpan={4}>
                                {t("adminSettings.system.aiAssist.noLocalProviders")}
                              </td>
                            </tr>
                          ) : (
                            <tr className="data-table-row">
                              <td className="data-table-cell data-table-cell--name">{savedLocalLlmProvider.label}</td>
                              ...
                              <td className="data-table-cell snapshot-table-actions">
                                <button
                                  type="button"
                  ...
                  <SettingsModalSection title={t("adminSettings.system.aiAssist.cloudProviders")} className="app-settings-modal-section--compact-controls">
                    ...
                    <div className="data-table-wrap data-table-wrap--elevated" style={{ maxHeight: 260 }}>
                      <table className="data-table" style={{ tableLayout: "fixed", width: "100%" }}>
                        <thead>
                          <tr>
                            <th className="data-table-header" style={{ width: "32%" }}>{t("adminSettings.system.aiAssist.provider")}</th>
                            <th className="data-table-header" style={{ width: "32%" }}>{t("adminSettings.system.aiAssist.secret")}</th>
                            <th className="data-table-header" style={{ width: "20%" }}>{t("adminSettings.system.aiAssist.models")}</th>
                            <th className="data-table-header" style={{ width: 64, textAlign: "right" }}>{t("adminSettings.system.aiAssist.actions")}</th>
                          </tr>
                        </thead>
                        <tbody>
                          {!savedCloudLlmProvider || !aiAssistLlmSettings ? (
                            ...
                            <tr className="data-table-row">
                              <td className="data-table-cell data-table-cell--name">{savedCloudLlmProvider.label}</td>
                              <td className="data-table-cell data-table-cell--muted">
                    ...
                    <SettingsModalSection title={t("adminSettings.system.aiAssist.models")}>
                      <div className="data-table-wrap data-table-wrap--elevated" style={{ maxHeight: 260 }}>
                        <table className="data-table" style={{ tableLayout: "fixed", width: "100%" }}>
                          <thead>
                            <tr>
                              <th className="data-table-header" style={{ width: "42%" }}>{t("adminSettings.system.aiAssist.model")}</th>
                              <th className="data-table-header" style={{ width: 260, whiteSpace: "nowrap" }}>{t("adminSettings.system.aiAssist.enabled")}</th>
                            </tr>
                          </thead>
                          <tbody>
                            {adminLocalModels.length === 0 ? (
                              <tr>
                                <td className="data-table-cell data-table-cell--muted" colSpan={2}>
                              ...
                              return (
                                <tr key={model.name} className="data-table-row">
                                  <td className="data-table-cell data-table-cell--name" style={{ minWidth: 0 }}>
                    ...
                    <SettingsModalSection title={t("adminSettings.system.aiAssist.models")}>
                      <div className="data-table-wrap data-table-wrap--elevated" style={{ maxHeight: 260 }}>
                        <table className="data-table" style={{ tableLayout: "fixed", width: "100%" }}>
                          <thead>
                            <tr>
                              <th className="data-table-header" style={{ width: "38%" }}>{t("adminSettings.system.aiAssist.model")}</th>
                              <th className="data-table-header" style={{ width: 140, whiteSpace: "nowrap" }}>{t("adminSettings.system.aiAssist.publisher")}</th>
                              <th className="data-table-header" style={{ width: 260, whiteSpace: "nowrap" }}>{t("adminSettings.system.aiAssist.enabled")}</th>
                            </tr>
                          </thead>
                          <tbody>
                            {adminCloudModels.length === 0 ? (
                              <tr>
                                <td className="data-table-cell data-table-cell--muted" colSpan={3}>
                              ...
                              return (
                                <tr key={model.id} className="data-table-row">
                                  <td className="data-table-cell data-table-cell--name" style={{ minWidth: 0 }}>
                                    <div style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }} title={model.name}>
                                      {model.name}
                                    </div>
                                    <div className="data-table-cell--muted" style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }} title={model.id}>
                                      {model.id}
                                    </div>
                                  </td>
                                  <td className="data-table-cell data-table-cell--muted" style={{ whiteSpace: "nowrap" }}>
                ...
                <section className="app-settings-modal-section">
                  ...
                  {auditLoading ? (
                    ...
                    authAuditEntries.length === 0 ? (
                      ...
                      <div className="data-table-wrap data-table-wrap--elevated" style={{ maxHeight: 520 }}>
                        <table className="data-table" style={{ tableLayout: "auto", width: "100%" }}>
                          <thead>
                            <tr>
                              <th
                                className={`data-table-header${adminUsersLogSortColumn === "time" ? " data-table-header--sorted" : ""}`}
                                style={{ whiteSpace: "nowrap" }}
                                onClick={() => toggleAdminUsersLogSort("time")}
                              >
                                {t("adminSettings.system.logs.time")}<span className="data-table-sort-icon">{sortIcon(adminUsersLogSortColumn === "time", adminUsersLogSortDirection)}</span>
                              </th>
                              <th
                                className={`data-table-header${adminUsersLogSortColumn === "event" ? " data-table-header--sorted" : ""}`}
                                onClick={() => toggleAdminUsersLogSort("event")}
                              >
                                {t("adminSettings.system.logs.event")}<span className="data-table-sort-icon">{sortIcon(adminUsersLogSortColumn === "event", adminUsersLogSortDirection)}</span>
                              </th>
                              <th
                                className={`data-table-header${adminUsersLogSortColumn === "outcome" ? " data-table-header--sorted" : ""}`}
                                onClick={() => toggleAdminUsersLogSort("outcome")}
                              >
                                {t("adminSettings.system.logs.outcome")}<span className="data-table-sort-icon">{sortIcon(adminUsersLogSortColumn === "outcome", adminUsersLogSortDirection)}</span>
                              </th>
                              <th
                                className={`data-table-header${adminUsersLogSortColumn === "user" ? " data-table-header--sorted" : ""}`}
                                onClick={() => toggleAdminUsersLogSort("user")}
                              >
                                {t("adminSettings.system.logs.user")}<span className="data-table-sort-icon">{sortIcon(adminUsersLogSortColumn === "user", adminUsersLogSortDirection)}</span>
                              </th>
                              <th
                                className={`data-table-header${adminUsersLogSortColumn === "ip" ? " data-table-header--sorted" : ""}`}
                                onClick={() => toggleAdminUsersLogSort("ip")}
                              >
                                {t("adminSettings.system.logs.ipAddress")}<span className="data-table-sort-icon">{sortIcon(adminUsersLogSortColumn === "ip", adminUsersLogSortDirection)}</span>
                              </th>
                              <th
                                className={`data-table-header${adminUsersLogSortColumn === "reason" ? " data-table-header--sorted" : ""}`}
                                onClick={() => toggleAdminUsersLogSort("reason")}
                              >
                                {t("adminSettings.system.logs.reason")}<span className="data-table-sort-icon">{sortIcon(adminUsersLogSortColumn === "reason", adminUsersLogSortDirection)}</span>
                              </th>
                              <th
                                className={`data-table-header${adminUsersLogSortColumn === "message" ? " data-table-header--sorted" : ""}`}
                                onClick={() => toggleAdminUsersLogSort("message")}
                              >
                                {t("adminSettings.system.logs.message")}<span className="data-table-sort-icon">{sortIcon(adminUsersLogSortColumn === "message", adminUsersLogSortDirection)}</span>
                              </th>
                            </tr>
                          </thead>
                          <tbody>
                            {sortedAuthAuditEntries.slice(0, 250).map((entry) => (
                              <tr key={entry.id}>
                                <td className="data-table-cell data-table-cell--muted" style={{ whiteSpace: "nowrap" }}>{formatPostgresTimestampMs(entry.timestampMs)}</td>
                                <td className="data-table-cell">{entry.event.replace(/^postgres\.auth\./, "")}</td>
                                <td className="data-table-cell">
                                ...
                                <td className="data-table-cell">
                                  ...
                                  {entry.authKind || entry.role ? (
                                    <div className="data-table-cell--muted">{[entry.authKind, entry.role].filter(Boolean).join(" / ")}</div>
                                  ) : null}
                                </td>
                                <td className="data-table-cell data-table-cell--muted">{entry.clientIp || "-"}</td>
                                <td className="data-table-cell data-table-cell--muted">{entry.reason || "-"}</td>
                                <td className="data-table-cell">{entry.message || "-"}</td>
                              </tr>
                            ))}
                          </tbody>
                        </table>
                      ...
                      <div className="data-table-wrap data-table-wrap--elevated" style={{ maxHeight: 520 }}>
                        <table className="data-table" style={{ tableLayout: "auto", width: "100%" }}>
                          <thead>
                            <tr>
                            <th
                              className={`data-table-header${adminProjectsLogSortColumn === "time" ? " data-table-header--sorted" : ""}`}
                              style={{ whiteSpace: "nowrap" }}
                              onClick={() => toggleAdminProjectsLogSort("time")}
                            >
                              {t("adminSettings.system.logs.time")}<span className="data-table-sort-icon">{sortIcon(adminProjectsLogSortColumn === "time", adminProjectsLogSortDirection)}</span>
                            </th>
                            <th
                              className={`data-table-header${adminProjectsLogSortColumn === "project" ? " data-table-header--sorted" : ""}`}
                              onClick={() => toggleAdminProjectsLogSort("project")}
                            >
                              {t("adminSettings.system.logs.project")}<span className="data-table-sort-icon">{sortIcon(adminProjectsLogSortColumn === "project", adminProjectsLogSortDirection)}</span>
                            </th>
                            <th
                              className={`data-table-header${adminProjectsLogSortColumn === "user" ? " data-table-header--sorted" : ""}`}
                              onClick={() => toggleAdminProjectsLogSort("user")}
                            >
                              {t("adminSettings.system.logs.user")}<span className="data-table-sort-icon">{sortIcon(adminProjectsLogSortColumn === "user", adminProjectsLogSortDirection)}</span>
                            </th>
                            <th
                              className={`data-table-header${adminProjectsLogSortColumn === "action" ? " data-table-header--sorted" : ""}`}
                              onClick={() => toggleAdminProjectsLogSort("action")}
                            >
                              {t("adminSettings.system.logs.action")}<span className="data-table-sort-icon">{sortIcon(adminProjectsLogSortColumn === "action", adminProjectsLogSortDirection)}</span>
                            </th>
                            <th
                              className={`data-table-header${adminProjectsLogSortColumn === "description" ? " data-table-header--sorted" : ""}`}
                              onClick={() => toggleAdminProjectsLogSort("description")}
                            >
                              {t("adminSettings.system.logs.description")}<span className="data-table-sort-icon">{sortIcon(adminProjectsLogSortColumn === "description", adminProjectsLogSortDirection)}</span>
                            </th>
                          </tr>
                        </thead>
                        <tbody>
                          {sortedProjectAuditEntries.slice(0, 500).map((entry) => (
                            <tr key={`${entry.projectId}:${entry.id}`}>
                              <td className="data-table-cell data-table-cell--muted" style={{ whiteSpace: "nowrap" }}>{formatPostgresDateTime(entry.occurredAt)}</td>
                              <td className="data-table-cell">{entry.projectName || entry.projectId}</td>
                              <td className="data-table-cell">{entry.userName || entry.userId || "-"}</td>
                              <td className="data-table-cell">
                        ...
                        {appUsers.filter((user) => user.active).length ? (
                          <div className="data-table-wrap data-table-wrap--elevated" style={{ maxHeight: 360 }}>
                            <table className="data-table">
                              <thead>
                                <tr>
                                  <th className="data-table-header">{t("adminSettings.projectModal.user")}</th>
                                  <th className="data-table-header">{t("adminSettings.projectModal.username")}</th>
                                  <th className="data-table-header">{t("adminSettings.projectModal.role")}</th>
                                </tr>
                              </thead>
                              <tbody>
                                {appUsers
                                  ...
                                  .map((user) => (
                                    <tr key={user.id} className="data-table-row">
                                      <td className="data-table-cell data-table-cell--name">{user.name}</td>
                                      <td className="data-table-cell data-table-cell--muted">{user.username}</td>
                                      <td className="data-table-cell">
                                        <select
                                          className="form-input"
              ...
              <div className="app-settings-modal-sections">
                <section className="app-settings-modal-section">
                  <div className="app-settings-modal-section-body">
                    ...
                    <div className="data-table-wrap data-table-wrap--elevated" style={{ maxHeight: 520, width: "fit-content", maxWidth: "100%", margin: "0 auto" }}>
                      <table className="data-table" style={{ tableLayout: "auto", width: "max-content", minWidth: 0 }}>
                        <thead>
                          <tr>
                            <th className="data-table-header">{t("adminSettings.system.projects.project")}</th>
                            <th className="data-table-header" style={{ width: "1%", whiteSpace: "nowrap" }}>{t("adminSettings.system.projects.status")}</th>
                            <th className="data-table-header" style={{ width: "1%", whiteSpace: "nowrap" }}>{t("adminSettings.system.projects.created")}</th>
                            <th className="data-table-header" style={{ width: "1%", whiteSpace: "nowrap" }}>{t("adminSettings.system.projects.lastUpdated")}</th>
                            <th className="data-table-header" style={{ width: "1%", whiteSpace: "nowrap" }}>{t("adminSettings.system.projects.actions")}</th>
                          </tr>
                        </thead>
                        <tbody>
                          {projects.length ? projects.map((project) => {
                              ...
                              >
                                ...
                                <td className="data-table-cell" style={{ whiteSpace: "nowrap" }}>
                                  ...
                                  {!project.active && project.disabledAt ? (
                                    <div className="data-table-cell--muted">{formatPostgresDateTime(project.disabledAt)}</div>
                                  ) : null}
                                </td>
                                <td className="data-table-cell data-table-cell--muted" style={{ whiteSpace: "nowrap" }}>{formatPostgresDateTime(project.createdAt)}</td>
                                <td className="data-table-cell data-table-cell--muted" style={{ whiteSpace: "nowrap" }}>{formatPostgresDateTime(project.updatedAt)}</td>
                                <td className="data-table-cell snapshot-table-actions">
                                  <button
                                    type="button"
                                    className="snapshot-actions-trigger"
                            ...
                            <tr>
                              <td className="data-table-cell data-table-cell--muted" colSpan={5}>{t("adminSettings.system.projects.none")}</td>
                            </tr>
                          )}
                        </tbody>
                      </table>
                        ...
                        {projects.length ? (
                          <div className="data-table-wrap data-table-wrap--elevated" style={{ maxHeight: 360 }}>
                            <table className="data-table">
                              <thead>
                                <tr>
                                  <th className="data-table-header">{t("adminSettings.userModal.project")}</th>
                                  <th className="data-table-header">{t("adminSettings.userModal.database")}</th>
                                  <th className="data-table-header">{t("adminSettings.userModal.role")}</th>
                                </tr>
                              </thead>
                              <tbody>
                                {projects.map((project) => (
                                  <tr
                                    key={project.id}
                                    className={`data-table-row${gettingStartedState.step === "createUser" && addUserTab === "projects" && gettingStartedState.projectId === project.id && !gettingStartedState.dismissed && !gettingStartedState.completed ? " getting-started-spotlight-target" : ""}`}
                                  >
                                    <td className="data-table-cell data-table-cell--name">{project.name}</td>
                                    <td className="data-table-cell data-table-cell--muted">{project.databaseName}</td>
                                    <td className="data-table-cell">
                                      <select
                                        className="form-input"
                  ...
                  <div className="app-settings-modal-section-body">
                    ...
                    <div className="data-table-wrap data-table-wrap--elevated" style={{ maxHeight: 520 }}>
                      <table className="data-table" style={{ tableLayout: "auto", width: "100%" }}>
                        <thead>
                          <tr>
                            <th className="data-table-header">{t("adminSettings.system.users.user")}</th>
                            <th className="data-table-header" style={{ width: "1%", whiteSpace: "nowrap" }}>{t("adminSettings.system.users.status")}</th>
                            <th className="data-table-header" style={{ width: "1%", whiteSpace: "nowrap" }}>{t("adminSettings.system.users.login")}</th>
                            <th className="data-table-header" style={{ width: "1%", whiteSpace: "nowrap" }}>{t("adminSettings.system.users.created")}</th>
                            <th className="data-table-header" style={{ width: "1%", whiteSpace: "nowrap" }}>{t("adminSettings.system.users.lastActive")}</th>
                            <th className="data-table-header" style={{ width: "1%", whiteSpace: "nowrap" }}>{t("adminSettings.system.users.actions")}</th>
                          </tr>
                        </thead>
                        <tbody>
                          {appUsers.length ? appUsers.map((user) => {
                            return (
                              ...
                              >
                                <td className="data-table-cell data-table-cell--name">
                                  <div>{user.name}</div>
                                  <div className="data-table-cell--muted">{user.username}</div>
                                </td>
                                <td className="data-table-cell" style={{ whiteSpace: "nowrap" }}>
                                  <div>{user.active ? t("adminSettings.system.users.active") : t("adminSettings.system.users.disabled")}</div>
                                  {user.mustChangePassword ? (
                                    <div className="data-table-cell--muted">{t("adminSettings.system.users.passwordResetRequired")}</div>
                                  ) : null}
                                </td>
                                <td className="data-table-cell" style={{ whiteSpace: "nowrap" }}>
                                  <div>{postgresUserLoginAccessLabel(user, t)}</div>
                                  {user.loginBlockedUntilMs && user.loginBlockedUntilMs > Date.now() ? (
                                    <div className="data-table-cell--muted">{t("adminSettings.system.users.until")} {formatPostgresTimestampMs(user.loginBlockedUntilMs)}</div>
                                  ) : user.loginFailedAttemptsLastHour > 0 ? (
                                    <div className="data-table-cell--muted">{user.loginFailedAttemptsLastHour} {t("adminSettings.system.users.failedLastHour")}</div>
                                  ) : null}
                                </td>
                                <td className="data-table-cell data-table-cell--muted" style={{ whiteSpace: "nowrap" }}>{formatPostgresDateTime(user.createdAt)}</td>
                                <td className="data-table-cell data-table-cell--muted" style={{ whiteSpace: "nowrap" }}>{user.lastLoginAt ? formatPostgresDateTime(user.lastLoginAt) : "-"}</td>
                                <td className="data-table-cell snapshot-table-actions">
                                  <button
                                    type="button"
                                    className="snapshot-actions-trigger"
                            ...
                            <tr>
                              <td className="data-table-cell data-table-cell--muted" colSpan={6}>{t("adminSettings.system.users.none")}</td>
                            </tr>
                          )}
                        </tbody>
                      </table>
                      ...
                      return (
                        <div className="admin-membership-lists">
                          <div className="admin-membership-list">
                            ...
                            {memberships.length ? (
                              <div className="data-table-wrap data-table-wrap--elevated admin-membership-table-wrap">
                                <table className="data-table">
                                  <thead>
                                    <tr>
                                      <th className="data-table-header">{t("adminSettings.system.users.project")}</th>
                                      <th className="data-table-header">{t("adminSettings.system.users.role")}</th>
                                      <th className="data-table-header admin-membership-icon-th" aria-label={t("adminSettings.system.users.removeAria")} />
                                    </tr>
                                  </thead>
                                  <tbody>
                                    {memberships.map((membership) => {
                                      ...
                                      return (
                                        <tr key={membership.id} className="data-table-row">
                                          <td className="data-table-cell data-table-cell--name">
                                            <div>{membershipProject?.name ?? membership.projectId}</div>
                                            <div className="data-table-cell--muted">{membershipProject?.databaseName ?? ""}</div>
                                          </td>
                                          <td className="data-table-cell">
                                            <select
                                              className="form-input"
                                          ...
                                          <td className="data-table-cell admin-membership-icon-cell">
                                            <button
                                              type="button"
                              ...
                              <div className="data-table-wrap data-table-wrap--elevated admin-membership-table-wrap">
                                <table className="data-table">
                                  <thead>
                                    <tr>
                                      <th className="data-table-header">{t("adminSettings.system.users.project")}</th>
                                      <th className="data-table-header">{t("adminSettings.system.users.status")}</th>
                                      <th className="data-table-header admin-membership-icon-th" aria-label={t("adminSettings.system.users.addAria")} />
                                    </tr>
                                  </thead>
                                  <tbody>
                                    {availableProjects.map((project) => {
                                      ...
                                      return (
                                        <tr key={project.id} className="data-table-row">
                                          <td className="data-table-cell data-table-cell--name">
                                            <div>{project.name}</div>
                                            <div className="data-table-cell--muted">{project.databaseName}</div>
                                          </td>
                                          <td className="data-table-cell">{project.active ? t("adminSettings.system.users.active") : t("adminSettings.system.users.disabled")}</td>
                                          <td className="data-table-cell admin-membership-icon-cell">
                                            <button
                                              type="button"
              ...
              <div className="app-settings-modal-sections">
                ...
                <section className="app-settings-modal-section">
                  ...
                  <div className="app-settings-modal-section-body">
                    ...
                    <div className="data-table-wrap data-table-wrap--elevated" style={{ maxHeight: 320 }}>
                      <table className="data-table">
                        <thead>
                          <tr>
                            <th className="data-table-header">{t("adminSettings.system.users.name")}</th>
                            <th className="data-table-header">{t("adminSettings.system.users.username")}</th>
                            <th className="data-table-header">{t("adminSettings.system.users.role")}</th>
                            <th className="data-table-header">{t("adminSettings.system.users.status")}</th>
                            <th className="data-table-header">{t("adminSettings.system.users.updated")}</th>
                            <th className="data-table-header">{t("adminSettings.system.users.action")}</th>
                          </tr>
                        </thead>
                        <tbody>
                          {appUsers.length ? appUsers.map((user) => (
                            <tr key={user.id} className="data-table-row">
                              ...
                              <td className="data-table-cell">{user.active ? t("adminSettings.system.users.active") : t("adminSettings.system.users.disabled")}</td>
                              <td className="data-table-cell data-table-cell--muted">{formatPostgresDateTime(user.updatedAt)}</td>
                              <td className="data-table-cell">
                ...
                <section className="app-settings-modal-section">
                  ...
                  <div className="app-settings-modal-section-body">
                    ...
                    {projects.length > 0 ? (
                      <div className="data-table-wrap data-table-wrap--elevated" style={{ marginTop: 16, maxHeight: 280 }}>
                        <table className="data-table">
                          <thead><tr><th className="data-table-header">{t("adminSettings.system.users.project")}</th><th className="data-table-header">{t("adminSettings.system.database.title")}</th><th className="data-table-header">{t("adminSettings.system.users.updated")}</th></tr></thead>
                          <tbody>
                            {projects.map((project) => (
                              <tr key={project.id} className="data-table-row">
                                <td className="data-table-cell data-table-cell--name">{project.name}</td>
                                <td className="data-table-cell data-table-cell--muted">{project.databaseName}</td>
                                <td className="data-table-cell data-table-cell--muted">{formatPostgresDateTime(project.updatedAt)}</td>
                              </tr>
                            ))}
                          </tbody>
                        </table>
      ...
      {membershipRemovalWarning ? (
        <ConfirmDialog
          ...
          onConfirm={() => void confirmRemoveProjectMembership(membershipRemovalWarning)}
          busy={removingMembershipId === membershipRemovalWarning.id}
          confirmLabel={t("common.remove")}
          busyLabel={t("adminSettings.system.users.removing")}
          tone="danger"
          modalClassName="modal--narrow"
          footerClassName="app-settings-modal-footer app-settings-modal-footer--actions-only membership-removal-actions"
        >
      ...
      {projectAccessWarning ? (
        <ConfirmDialog
          ...
          confirmDisabled={authSession.authKind !== "postgres_admin"}
          confirmLabel={projectAccessWarning.action === "delete"
            ? t("common.delete")
            : projectAccessWarning.action === "enable"
              ? t("adminSettings.system.users.enable")
              : t("adminSettings.system.users.disable")}
          busyLabel={projectAccessWarning.action === "delete"
            ? t("common.deleting")
            : projectAccessWarning.action === "enable"
              ? t("adminSettings.system.users.enabling")
              : t("adminSettings.system.users.disabling")}
          tone={projectAccessWarning.action === "delete" ? "danger" : "primary"}
          modalClassName="modal--narrow"
        >
